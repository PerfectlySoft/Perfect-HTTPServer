...
public extension HTTPFilter {
    ...
    public struct CompressResponse: HTTPResponseFilter {
        
        var compressTypes: [MimeType]
        var ignoreTypes: [MimeType]
        
        public init(compressTypes: [MimeType]? = nil, ignoreTypes: [MimeType]? = nil) {
            self.compressTypes = compressTypes ?? ["*/*"]
            self.ignoreTypes = ignoreTypes ?? ["image/*", "video/*", "audio/*"]
        }
